...
BOT_COMMAND_BINDINGS: tuple[BotCommandBinding, ...] = (
    ...
    BotCommandBinding("mode", "Switch fixed/flex/wrapper/audit/dual-brain mode"),
    ...
    BotCommandBinding("notepad", "View or edit the memory+ daily notepad"),
    ...
    BotCommandBinding("focus", "Pause and narrow work to your request"),
    ...
    BotCommandBinding("stream", "Control Telegram streaming [on|off|status]"),
    BotCommandBinding("preview", "Toggle answer stream preview [on|off|status]"),
