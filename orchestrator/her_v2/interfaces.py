...
class ProviderFailureCode(str, Enum):
    ...
    MODEL_CAPABILITY_UNKNOWN = "MODEL_CAPABILITY_UNKNOWN"
    ADAPTER_MEDIA_ROUTE_UNIMPLEMENTED = "ADAPTER_MEDIA_ROUTE_UNIMPLEMENTED"
    MEDIA_POLICY_BLOCKED = "MEDIA_POLICY_BLOCKED"
    MEDIA_FALLBACK_UNAVAILABLE = "MEDIA_FALLBACK_UNAVAILABLE"
