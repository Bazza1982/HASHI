...
COMMAND_SPECS: tuple[CommandSpec, ...] = (
    ...
    CommandSpec("retry", "cmd_retry", "Resend response or rerun prompt", "execution"),
    CommandSpec("verbose", "cmd_verbose", "Control detailed task status", "session"),
    CommandSpec("think", "cmd_think", "Control thinking trace display", "session"),
    CommandSpec("stream", "cmd_stream", "Control Telegram streaming", "session"),
    CommandSpec("preview", "cmd_preview", "Control live answer preview", "session"),
