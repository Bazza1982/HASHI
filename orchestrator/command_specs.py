...
COMMAND_SPECS: tuple[CommandSpec, ...] = (
    ...
    CommandSpec("version", "cmd_version", "View trusted running and source versions", "everyday"),
    ...
    CommandSpec("backend", "cmd_backend", "View or switch backend", "models"),
    ...
    CommandSpec("new", "cmd_new", "Create and use a new Session", "session"),
    CommandSpec("fresh", "cmd_fresh", "Start a fresh context generation", "session"),
    CommandSpec("sessions", "cmd_sessions", "List this Agent's Sessions", "session"),
    CommandSpec("use", "cmd_use", "Switch the current channel to a Session", "session"),
    ...
    CommandSpec("promote", "cmd_promote", "Promote Session history to Agent memory", "session", sensitive=True),
