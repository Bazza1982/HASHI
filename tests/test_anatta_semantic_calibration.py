...
from orchestrator.anatta.models import DriveContribution, EmotionalAnnotation, EmergentTurnState, PromptInjection, TurnContext
...
def test_anatta_pre_turn_provider_injects_and_reuses_cached_state() -> None:
    class _Bridge:
