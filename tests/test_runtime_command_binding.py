...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("her_route_custom:review", "callback_model"),
        ("her_route_model:review:0:abcdef:1:abcdef", "callback_model"),
        ("her_route_reasoning:review:1:abcdef", "callback_model"),
