...
| Other writers, Memory/Wiki scan transactions | Respective existing owners | Still require inventory and separate implementation; not covered by the two rows above |
