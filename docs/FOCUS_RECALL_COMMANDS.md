...
| --- | --- | --- | --- |
| `/stop` | Interrupted and saved durably | READY cleared; FUTURE preserved | Later text enters unchanged; the Engine interprets it from ordered conversation and recovery context |
