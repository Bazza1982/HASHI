...
All three modes always use the lifecycle-wide semantic cognitive control.
It cannot be disabled per mode, Agent, provider, or deployment. One compact
evidence-aware TaskState is
