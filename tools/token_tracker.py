...
PRICING: dict[str, dict[str, float]] = {
    ...
    # Antigravity CLI (agy) models - static fallback pricing (USD per million tokens)
    "gemini-3.8-flash-high":    {"input": 0.75,  "cached": 0.075, "output": 3.75},
    "gemini-3.8-flash-medium":  {"input": 0.75,  "cached": 0.075, "output": 3.75},
    "gemini-3.8-flash-low":     {"input": 0.75,  "cached": 0.075, "output": 3.75},
    "gemini-3.7-flash-high":    {"input": 0.75,  "cached": 0.075, "output": 3.75},
    "gemini-3.7-flash-medium":  {"input": 0.75,  "cached": 0.075, "output": 3.75},
    "gemini-3.7-flash-low":     {"input": 0.75,  "cached": 0.075, "output": 3.75},
    "gemini-3.6-flash-high":    {"input": 0.75,  "cached": 0.075, "output": 3.75},
    "gemini-3.6-flash-medium":  {"input": 0.75,  "cached": 0.075, "output": 3.75},
    "gemini-3.6-flash-low":     {"input": 0.75,  "cached": 0.075, "output": 3.75},
    "gemini-3.1-pro-high":      {"input": 2.00,  "cached": 0.20,  "output": 12.00, "thinking": 12.00},
    "gemini-3.1-pro-low":       {"input": 2.00,  "cached": 0.20,  "output": 12.00, "thinking": 12.00},
    "claude-opus-4-6-thinking": {"input": 5.00,  "cached": 0.50,  "output": 25.00},
    "gpt-oss-120b-medium":      {"input": 0.037, "cached": 0.0037, "output": 0.17},
