...
TOOL_TIERS: dict[str, list[str]] = {
    ...
    "windows_use": [
        "windows_screenshot", "windows_mouse_move", "windows_click", "windows_drag",
    ...
    async def _dispatch(self, tool_name: str, arguments: dict) -> str | StructuredToolOutput:
        ...
        if tool_name.startswith("browser_"):
            ...
            _browser_dispatch = {
                ...
                "browser_react":         execute_browser_react,
        ...
        if tool_name.startswith("windows_"):
            ...
            _windows_dispatch = {
                ...
                "windows_drag": execute_windows_drag,
